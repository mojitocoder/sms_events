...
config :sms_events, SmsEventsWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "IEqs6YfAHBXB65fj9cLWRqdbiXGBSymoXoYLTVBMeUiI6myJ+qlVfnhg8/5B6qS/",
  render_errors: [view: SmsEventsWeb.ErrorView, accepts: ~w(html json)],
  pubsub: [name: SmsEvents.PubSub, adapter: Phoenix.PubSub.PG2]
